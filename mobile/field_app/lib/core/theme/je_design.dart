...
abstract final class JeDesign {
  ...
  static Color severityBarColor(ColorScheme cs, String? tier) {
    return AppDesign.severityColor(cs, tier);
  }

  static Color severityBadgeBg(ColorScheme cs, String? tier) {
    return AppDesign.severityBackground(cs, tier);
  }
}
