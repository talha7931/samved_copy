-- JE site check-in writes je_checkin_* + status; fn_guard_ticket_columns must treat
-- those columns like other allowed JE fields (excluded from the final catch-all diff).
